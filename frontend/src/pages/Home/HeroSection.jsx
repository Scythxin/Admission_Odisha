...
{t("heroDescription")}
            ...
            <div className="bg-gradient-to-r from-[#F8F8FC] to-[#F0EEFF] rounded-2xl p-5 md:p-6 mt-6 md:mt-8 max-w-[650px] mx-auto lg:mx-0 border border-[#E0D6FF] shadow-sm">
